...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-grass-d5a3
```

A live public deployment of this template is available at [https://nameless-grass-d5a3.templates.workers.dev](https://nameless-grass-d5a3.templates.workers.dev)
